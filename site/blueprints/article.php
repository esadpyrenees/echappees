...
fields:
  ...
  title_note:
    label: information complémentaire de titre (ou note de titre)
    type:  textarea
  ...
  ARTICLE_interviewer:
    label: Adresse de la fiche de l'interviewer
    type: structure
    entry: >
      {{auteur_uid}}    
    fields:
  ...
  ARTICLE_CHAPEAU_REDACTION:
    label: Chapeau de la rédaction
    type: textarea
    buttons: 
      - bold
      - italic
  ...
  INFO_2:
    label: Saisie de l'iconographie
    type: info
    text: >
      - Pour que votre iconographie (images, vidéos, audio) apparaisse directement dans le texte : 

      . télécharger vos médias en cliquant sur le bouton *Ajouter* dans la section *Fichiers* (à gauche de votre écran)

      . puis, glissez-les directement dans le corps du texte à l'endroit où vous désirez les voir apparaître


      - Pour créer une galerie d'images qui accompagnera votre article, veulliez :

      . télécharger vos images en cliquant sur le bouton *Ajouter* dans la section *Fichiers* (à gauche de votre écran)

      . puis, glissez-les directement dans le champ de saisie ci-dessous les unes à la suite des autres
  ...
  ARTICLE_CHAPEAU_AUTEUR:
    label: Chapeau de l'auteur (optionnel)
    type: textarea
    buttons: 
      - bold
      - italic
  ...
  CHAPEAU_NOTE_PRINT:
    label: Notes print du chapeau de l'auteur
    type: textarea
